...
use num::Bounded;
use resource::GPUVec;
use resource::{AllocationType, BufferType, Mesh, IndexNum};
...
pub fn parse(
    ...
    let mut groups_ids: Vec<Vec<Point3<IndexNum>>> = Vec::new();
...
fn parse_usemtl<'a>(
    ...
    groups_ids: &mut Vec<Vec<Point3<IndexNum>>>,
...
fn parse_f<'a>(
    ...
    for word in ws {
        ...
        assert!(x >= 0 && y >= 0 && z >= 0);
        groups_ids[curr_group].push(Point3::new(x as IndexNum, y as IndexNum, z as IndexNum));
...
fn reformat(
    ...
    uvs: Option<Vec<UV>>,
    groups_ids: Vec<Vec<Point3<IndexNum>>>,
    groups: HashMap<String, usize>,
    group2mtl: HashMap<usize, MtlMaterial>,
) -> Vec<(String, Mesh, Option<MtlMaterial>)> {
    let mut vt2id: HashMap<Point3<IndexNum>, IndexNum> = HashMap::new();
    let mut vertex_ids: Vec<IndexNum> = Vec::new();
    ...
    let mut resfs: Vec<Vec<Point3<IndexNum>>> = Vec::new();
    let mut allfs: Vec<Point3<IndexNum>> = Vec::new();
