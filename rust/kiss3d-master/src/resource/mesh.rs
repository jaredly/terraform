...
use resource::{ShaderAttribute, IndexNum};
...
pub struct Mesh {
    ...
    faces: Arc<RwLock<GPUVec<Point3<IndexNum>>>>,
    normals: Arc<RwLock<GPUVec<Vector3<f32>>>>,
    uvs: Arc<RwLock<GPUVec<Point2<f32>>>>,
    edges: Option<Arc<RwLock<GPUVec<Point2<IndexNum>>>>>,
}
...
impl Mesh {
    ...
    /// This mesh faces.
    pub fn faces(&self) -> &Arc<RwLock<GPUVec<Point3<IndexNum>>>> {
        &self.faces
    }
